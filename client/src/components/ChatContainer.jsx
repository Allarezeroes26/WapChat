...
const ChatContainer = () => {
  ...
  const { messages, getMessages, isMessagesLoading, selectedUser, focusMessage, unFocusMessage } = useChatStore()
  ...
  }, [selectedUser._id, getMessages, focusMessage, unFocusMessage])
