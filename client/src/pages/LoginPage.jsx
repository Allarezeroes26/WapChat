  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className='text-center mb-8'>
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className='text-2xl font-display font-bold mt-2'>Login</h1>
              <p className='text-base-content/60 font-paragraph'>Welcome back! Please login to your account.</p>
            </div>
          </div>
      ...
      <ImagePattern 
        ...
        subtitle="Connect with friends, chat securely, and share updates with your network." 
      />
    </div>
  )
}
