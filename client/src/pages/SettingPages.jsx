...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! How's the new theme looking?", isSent: false },
  { id: 2, content: "Looks great! Very easy on the eyes.", isSent: true }
]
...
const SettingPages = () => {
  ...
  return (
    <div className='h-screen container font-paragraph mx-auto px-4 pt-20 max-w-5xl'>
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-base-300 bg-base-100 p-4 shadow-sm">
          <div className="max-w-md mx-auto">
            <div className="bg-base-200 rounded-xl overflow-hidden shadow-sm">
