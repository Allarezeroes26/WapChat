...
const SignUpPage = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className='text-center mb-8'>
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className='text-base-content/60 font-paragraph'>Get started with your free account</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className='space-y-6 font-paragraph'>
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input 
                type="text"
                className='input font-paragraph input-bordered w-full pl-13'
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input 
                type="text"
                className='input font-paragraph input-bordered w-full pl-10'
      ...
      <ImagePattern title="Join our community" subtitle="Lorem ipsum dolor sit amet consectetur adipisicing elit."/>
    </div>
  )
}
